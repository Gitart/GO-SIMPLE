...
func main(){
	...
	Init(confPath)
	fmt.Println("Platform  ....", Default.Platform)
	fmt.Println("Ripple    ....", Default.Ripple.API)
	fmt.Println("Tezos     ....", Default.Tezos.API)
	fmt.Println("Tron      ....", Default.Tron.API)
	fmt.Println("filecoin  ....", Default.Filecoin.API)
	fmt.Println("filecoin  ....", Default.Filecoin.Explorer)
	fmt.Println("Observer  ....", Default.Observer.FetchBlocksInterval)
	fmt.Println("Observer  ....", Default.Observer.BlockPoll.Min)

	
	// fmt.Println("Tezos ....", Default.Tezos.Rpc)
	// fmt.Println("Tezos ....", Default.Tezos.Baker)
