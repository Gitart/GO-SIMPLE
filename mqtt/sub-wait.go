// https://github.com/eclipse/paho.mqtt.golang/blob/master/cmd/docker/subscriber/main.go
...
const (
    ...
    CLIENTID         = "mqtt_client" //"mqtt_subscriber"
...
func main() {
    ...
    // (will keep trying to connect and will reconnect if network drops)
    ...
    // Messages will be delivered asynchronously 
    // so we just need to wait for a signal to shutdown
